...
def check_resourses():
    ...
    for i in resources:
        for n in recourses_option:
            if str(resources[n]) > str(recourses_option[i]):
                resources.pop(recourses_option[n])
                print("Soryy there is not enough water")
                print(recourses_option[i])
                break
            else:
                print("All good")
                break
